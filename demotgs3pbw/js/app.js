...
const app = new Vue({
    ...
    data() {
        return {
            ...
            currentLocalTime: '',
            loadingText: '', // FIX: Mendaftarkan Properti Agar Teks Status Loading Terbaca Sempurna
    ...
    methods: {
        ...
        handleLogin() {
            if (this.loginForm.email && this.loginForm.password === 'admin123') {
                ...
                setTimeout(() => {
                    ...
                    // Memicu prapendaftaran toast secara reaktif
                    this.showToastNotification('Login Berhasil! Selamat Datang di SITTA-UT.');
                }, 1000); 
            } else {
                this.triggerSimpleAlert('Login Gagal', 'Email atau password salah! (Password default: admin123)');
            }
        },
        handleLogout() {
            ...
            setTimeout(() => {
                ...
                // Menampilkan toast berhasil logout di halaman login
